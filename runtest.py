...
from case import LoginPage, RegisterPage, ForgetPassword, HomePage, CategoryPage, SearchPage, HomeMine, ComicDetail, ReadPage, Comment, UserActivity
...
def Test_suite():
    ...
    print '1.登录/2.注册/3.找回密码/4.首页/5.分类/6.搜索/7.我的/8.用户动态页面/9.漫画详情页/10.评论页/11.漫画阅读页'
    ...
    if num == '1':
        ...
        print '即将开始执行用户动态页面测试用例'
        suite.addTest(unittest.makeSuite(UserActivity.UserActivityTest))
    elif num == '9':
