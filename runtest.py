...
from case import LoginPage, RegisterPage, ForgetPassword, HomePage, CategoryPage, SearchPage, HomeMine, ComicDetail
...
def Test_suite():
    ...
    print '1.登录/2.注册/3.找回密码/4.首页/5.分类/6.搜索/7.我的/8.漫画详情页'
